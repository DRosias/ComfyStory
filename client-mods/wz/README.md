...
If the working client was installed with administrator-only write permissions, run the script from an elevated PowerShell so it can replace `client\wz\Data.wz`.
